...
const STRINGS = {
  en: {
    ...
    status: { start: 'START', tutorial: 'HELLO', ready: 'TAP', listening: 'LISTENING', thinking: 'THINKING', answer: 'ANSWER', settings: 'SETTINGS' },
    ...
    permission: 'Now I will ask to use the camera and microphone. Please tap Allow.',
    thanks: 'Thank you.',
    defaultQuestion: 'Describe what you see.',
    tutorial: [
      'Welcome to Eyes for Everyone.',
      'The whole screen is one big button.',
      'Tap once to take a photo.',
      'Then ask your question out loud, and tap again when you finish.',
      'I will answer out loud.',
      'Tap again to ask another question about the same photo.',
      'Double tap to take a new photo.',
      'Press and hold to hear the answer again.',
      'Hold for three seconds to open settings.',
      'You can also say: repeat, faster, slower, louder, change language, or bigger text.',
    ],
    settings: {
    ...
    sr: { skip: 'Skip', takePhoto: 'Take photo', stop: 'Stop and ask', wait: 'Please wait', askAgain: 'Ask again', newPhoto: 'New photo', repeat: 'Repeat answer', settings: 'Settings' },
  },

  ar: {
    appName: 'عيون للجميع',
    status: { start: 'ابدأ', tutorial: 'مرحبًا', ready: 'انقر', listening: 'أستمع', thinking: 'أفكر', answer: 'الإجابة', settings: 'الإعدادات' },
    ...
    permission: 'الآن سأطلب استخدام الكاميرا والميكروفون. يرجى النقر على سماح.',
    thanks: 'شكرًا لك.',
    defaultQuestion: 'صف ما تراه.',
    tutorial: [
      'مرحبًا بك في عيون للجميع.',
      'الشاشة كلها زر واحد كبير.',
      'انقر مرة واحدة لالتقاط صورة.',
      'ثم اسأل سؤالك بصوت عالٍ، وانقر مرة أخرى عندما تنتهي.',
      'سأجيبك بصوت عالٍ.',
      'انقر مرة أخرى لتسأل سؤالًا آخر عن نفس الصورة.',
      'انقر مرتين لالتقاط صورة جديدة.',
      'اضغط مطولًا لسماع الإجابة مرة أخرى.',
      'اضغط مطولًا لثلاث ثوانٍ لفتح الإعدادات.',
      'يمكنك أيضًا أن تقول: كرر، أسرع، أبطأ، أعلى، غيّر اللغة، أو كبّر الخط.',
    ],
    settings: {
    ...
    sr: { skip: 'تخطَّ', takePhoto: 'التقط صورة', stop: 'توقف واسأل', wait: 'يرجى الانتظار', askAgain: 'اسأل مرة أخرى', newPhoto: 'صورة جديدة', repeat: 'كرر الإجابة', settings: 'الإعدادات' },
  },

  ml: {
    appName: 'എല്ലാവർക്കും കണ്ണുകൾ',
    status: { start: 'തുടങ്ങുക', tutorial: 'നമസ്കാരം', ready: 'തൊടുക', listening: 'കേൾക്കുന്നു', thinking: 'ചിന്തിക്കുന്നു', answer: 'ഉത്തരം', settings: 'ക്രമീകരണങ്ങൾ' },
    ...
    permission: 'ഇനി ഞാൻ ക്യാമറയും മൈക്രോഫോണും ഉപയോഗിക്കാൻ അനുവാദം ചോദിക്കും. ദയവായി Allow അമർത്തുക.',
    thanks: 'നന്ദി.',
    defaultQuestion: 'നിങ്ങൾ കാണുന്നത് വിവരിക്കുക.',
    tutorial: [
      'എല്ലാവർക്കും കണ്ണുകളിലേക്ക് സ്വാഗതം.',
      'സ്ക്രീൻ മുഴുവൻ ഒരു വലിയ ബട്ടൺ ആണ്.',
      'ഫോട്ടോ എടുക്കാൻ ഒരു തവണ തൊടുക.',
      'എന്നിട്ട് നിങ്ങളുടെ ചോദ്യം ഉറക്കെ ചോദിക്കുക, തീരുമ്പോൾ വീണ്ടും തൊടുക.',
      'ഞാൻ ഉറക്കെ ഉത്തരം പറയും.',
      'അതേ ഫോട്ടോയെക്കുറിച്ച് വീണ്ടും ചോദിക്കാൻ വീണ്ടും തൊടുക.',
      'പുതിയ ഫോട്ടോ എടുക്കാൻ രണ്ടു തവണ തൊടുക.',
      'ഉത്തരം വീണ്ടും കേൾക്കാൻ അമർത്തിപ്പിടിക്കുക.',
      'ക്രമീകരണങ്ങൾ തുറക്കാൻ മൂന്ന് സെക്കൻഡ് അമർത്തിപ്പിടിക്കുക.',
      'നിങ്ങൾക്ക് ഇങ്ങനെയും പറയാം: ആവർത്തിക്കുക, വേഗം, പതുക്കെ, ഉച്ചത്തിൽ, ഭാഷ മാറ്റുക, വലിയ അക്ഷരം.',
    ],
    settings: {
    ...
    sr: { skip: 'ഒഴിവാക്കുക', takePhoto: 'ഫോട്ടോ എടുക്കുക', stop: 'നിർത്തി ചോദിക്കുക', wait: 'ദയവായി കാത്തിരിക്കുക', askAgain: 'വീണ്ടും ചോദിക്കുക', newPhoto: 'പുതിയ ഫോട്ടോ', repeat: 'ഉത്തരം ആവർത്തിക്കുക', settings: 'ക്രമീകരണങ്ങൾ' },
  },
};
